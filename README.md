...
| Cor               | Hexadecimal                                                |
| ----------------- | --------------------------------------------------------- |
| Primary           | ![#6e00ff](https://via.placeholder.com/15/6e00ff/000000?text=+) `#6e00ff` |
| Secondary         | ![#ff00aa](https://via.placeholder.com/15/ff00aa/000000?text=+) `#ff00aa` |
| Dark Background   | ![#0f0a1a](https://via.placeholder.com/15/0f0a1a/000000?text=+) `#0f0a1a` |
| Light Text        | ![#f0e6ff](https://via.placeholder.com/15/f0e6ff/000000?text=+) `#f0e6ff` |
| Accent            | ![#00ffcc](https://via.placeholder.com/15/00ffcc/000000?text=+) `#00ffcc` |
